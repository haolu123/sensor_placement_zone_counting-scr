...
class Env_sensor_coverage(Env):
    Sensor_FoV_m = 1 # the half edge size of the FoV(square) of L5 ToF sensor; install at 2.5m height ceilings
    
    def __init__(self, grid_fp, grid_size):
        super(Env_sensor_coverage, self).__init__(grid_fp)
        self.G = None
        self.S_FoV_grids = self.Sensor_FoV_m // grid_size
